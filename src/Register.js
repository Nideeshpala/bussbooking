...
function Register() {
    ...
    const handlesubmit = async (e) => {
        ...
        const { name, email, password, gender, dob, cpassword } = newaccount
  ...
  <Row className='w-100'>
    <Col lg={6} className=''>
      <Form>
        <div className='register shadow-lg container-fluid w-75'>
          <div class="cam rounded-bottom-1"></div>
          <h1 className='heading'>Sign Up</h1>
          <div className='lane1'>
            <div class="inputre form-floating mb-3">
              <input type="text" class="form-control" name='name' onChange={userdetails} required id="sname" placeholder="Name"></input>
          ...
          <div className='lane2'>
            <div class="dob inputre form-floating mb-3   ">
              <input type="date" class="dos form-control" id="dob" name='dob' onChange={userdetails} required placeholder="Date of Birth"></input>
